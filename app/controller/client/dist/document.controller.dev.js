...
var pageSize = 1;
var pageNumber;
ZOHO.CREATOR.init().then(function _callee3() {
  var configCountDocuments, cntRecord;
  return regeneratorRuntime.async(function _callee3$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          configCountDocuments = {
          ...
          _context3.next = 3;
          return regeneratorRuntime.awrap(ZOHO.CREATOR.API.getRecordCount(configCountDocuments).then(function (response) {
            ...
            for (var i = 1; i <= cntRecord; i++) {
              pagination.innerHTML += "<span class=\"page-item\" data-page=\"".concat(i, "\">").concat(i, "</span>");
            }

            pagination.innerHTML += "<span class=\"page-item\" data-page=\"".concat(Math.ceil(cntRecord / pageSize), "\">Trang Cu\u1ED1i</span>");
            var boxPagination = document.querySelector('.section-pagination');
                ...
                return regeneratorRuntime.async(function _callee2$(_context2) {
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        pageNumber = parseInt(this.getAttribute('data-page')); // Cập nhật trạng thái active
...
function likeDocument(buttonElement) {
  return regeneratorRuntime.async(function likeDocument$(_context5) {
    while (1) {
...
function createDocuments() {
  return regeneratorRuntime.async(function createDocuments$(_context8) {
    while (1) {
      switch (_context8.prev = _context8.next) {
        case 0:
          _context8.next = 2;
          return regeneratorRuntime.awrap(ZOHO.CREATOR.init().then(function _callee6() {
              ...
              while (1) {
                switch (_context7.prev = _context7.next) {
                  case 0:
                    ...
                    _context7.next = 5;
                    return regeneratorRuntime.awrap(ZOHO.CREATOR.API.getAllRecords(configGetDocument).then(function _callee5(response) {
                      var recordDocuments, i, documentRecord, regex, originalUrl, parts, desiredPart, encodedFilePath, modifiedDesiredPart, baseUrl, fileUrl, documentBlock, heart, configCountFavoriteDocument, section_2_document;
                        ...
                        while (1) {
                          switch (_context6.prev = _context6.next) {
                            ...
                            case 3:
                              ...
                              documentRecord = recordDocuments[i];
                              regex = new RegExp(localStorage.getItem('keyword'), 'i'); // URL của tệp tải xuống
